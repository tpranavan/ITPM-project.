...
const Doctors_add = (props, errors) => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:4000/doctors/${id}`).then((response) => {
      ...
      setName(response.data.DName);
      setSpecialization(response.data.Speci);
      setSlnc(response.data.SLNC);
      setExperiance(response.data.Exper);
  ...
  function UpdateDoctor() {
    ...
    if (
      ...
      axios
        .patch(`http://localhost:4000/doctors/${id}`, {
          DName: name,
                ...
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left  ml-3 header-user-info">
                      <div className="widget-heading">Admin Aishwarya</div>
              ...
              <div className={classes.root}>
                <Paper className={classes.paper}>
                  <h2 className="Login_heading">
                    Update {doctors.DName}'s Details
                  </h2>
