...
function Hospital_edit() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:4000/hospital/${id}`).then((response) => {
     
      setName(response.data.name);
      setLocation(response.data.location);
      setContact(response.data.contact);
      setWarddetails(response.data.warddetails);
  ...
  function UpdateHospitalCompany() {
    // setError(null);
    // setLoading(true);
    ...
    //   });
      axios
        .patch(`http://localhost:4000/hospital/${id}`, {
          name: name,
          location: location,
          contact: contact,
                  ...
                  <Form>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="text"
                          defaultValue={hospital.warddetails}
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="">
                      ...
                      <Col sm={9}>
                        <Form.Control
                          type="number"
                          defaultValue={hospital.staffcount}
